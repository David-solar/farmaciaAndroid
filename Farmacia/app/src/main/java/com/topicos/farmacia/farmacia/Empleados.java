...
public class Empleados extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mostrar();
        lis = (ListView) findViewById(R.id.lv_e);
        ...
        lis.setOnItemLongClickListener(new AdapterView.OnItemLongClickListener()
        {
            ...
            public boolean onItemLongClick(AdapterView<?> parent, View view, int position, long id)
            {
                ...
                mActionMode = Empleados.this.startActionMode(amc);
    ...
    public void mostrar()
    {
        ...
        if(db != null)
        {
                ...
                do
                {
                    String linea =
                            "Id: " + c.getInt(0) + "\n" +
                                    ...
                                    "Fecha Nacimiento: " + c.getString(2) + "\n" +
                                    "Fecha Ingreso: " + c.getString(3) + "\n" +
                                    "Sueldo: " + c.getDouble(4) + "\n" +
            ...
            ListView lista = (ListView) findViewById(R.id.lv_e);
    ...
    private void Borrar()
    {
        ...
        Cursor c1 = db.rawQuery("select id from Empleados", null);
        ...
        if(db != null)
        {
            long res = db.delete("Empleados", "id=" + id, null);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        {
            case R.id.nuevo:
                Intent in_mod = new Intent(this, AltasEmpleados.class);
                Toast.makeText(getApplicationContext(), "Item Altas EMpleados", Toast.LENGTH_SHORT).show();
